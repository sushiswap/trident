...
contract HybridPoolHarness is HybridPool {
    ...
    function mint(bytes memory data) public override lock returns (uint256 liquidity) {}

    function burn(bytes memory data) public override lock returns (IPool.TokenAmount[] memory withdrawnAmounts) {}

    function burnSingle(bytes memory data) public override lock returns (uint256 amount) {}

    function swap(bytes memory data) public override lock returns (uint256 amountOut) {}

    function flashSwap(bytes memory data) public override lock returns (uint256 amountOut) {}
