...
contract ConcentratedLiquidityPool is IPool {
    ...
    function burn(bytes calldata data) public override lock returns (IPool.TokenAmount[] memory withdrawnAmounts) {
        (int24 lowerOld, int24 lower, int24 upperOld, int24 upper, uint128 amount, address recipient, bool unwrapBento) = abi.decode(
            data,
            (int24, int24, int24, int24, uint128, address, bool)
        );
    ...
    function swap(bytes calldata data) public override lock returns (uint256 amountOut) {
        (bool zeroForOne, uint256 amountIn, address recipient, bool unwrapBento) = abi.decode(
            data,
    ...
    function getFeeGrowthInside(int24 lowerTick, int24 upperTick) public view returns (uint256 feeGrowthInside0X128, uint256 feeGrowthInside1X128) {
