...
/*IPool,*/
contract HybridPool is TridentERC20 {
    ...
    uint256 public constant poolType = 3;
    ...
    //         );
    //     }
    //     liquidityOptimal[0] = TokenAmount({token: liquidityInputs[0].token, amount: amountA});
    //     liquidityOptimal[1] = TokenAmount({token: liquidityInputs[1].token, amount: amountB});
