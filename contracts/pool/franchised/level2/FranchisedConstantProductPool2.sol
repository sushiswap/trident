...
/// @notice Trident exchange franchised pool (level 2) template with constant product formula for swapping between an ERC-20 token pair.
/// @dev The reserves are stored as bento shares.
///      The curve is applied to shares as well. This pool does not care about the underlying amounts.
contract FranchisedConstantProductPool2 is IPool, TridentFranchisedERC20 {
    ...
    bytes32 public constant override poolIdentifier = "Trident:FranchisedCP2";
    ...
    constructor(bytes memory _deployData, address _masterDeployer) {
        ...
        TridentFranchisedERC20.initialize(_whiteListManager, _operator);
