...
contract TridentNFTFractionalizer {
    function fractionalize(address recipient) external returns (TridentNFTfraction fraction) {
        fraction = new TridentNFTfraction();
        fraction.mint(recipient, 100 * 1 ether);
    }
}
