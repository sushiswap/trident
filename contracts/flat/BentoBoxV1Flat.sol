...
contract BoringFactory {
    ...
    function deploy(
        ...
        bytes calldata data,
        bool useCreate2
    ) public virtual payable returns (address cloneAddress) {
...
contract BentoBoxV1 is MasterContractManager, BoringBatchable {
    ...
    uint256 internal constant STRATEGY_DELAY = 2 weeks;
    ...
    function deposit(
        ...
        uint256 amount,
        uint256 share
    ) public virtual payable allowed(from) returns (uint256 amountOut, uint256 shareOut) {
        // Checks
